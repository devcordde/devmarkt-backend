...
public class QuestionMutationTest extends DevmarktTest {
  ...
  public void addQuestion_success(QuestionMutation questionMutation, TemplateMutation templateMutation) {
    templateMutation.createTemplate("test", List.of(new Question(-1,
        null, 0, "How are you?")));
